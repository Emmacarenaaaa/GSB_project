<div class="container">
    <div class="structure-hero pt-lg-5 pt-4">
        <h1 class="titre text-center">Nouveaux Rapports de Visite</h1>
        <p class="text-center">Liste des rapports validés et non consultés</p>
    </div>
        ...
        <div class="col-12 m-0 mt-4">
            ...
            <?php if (empty($result)): ?>
                ...
                <div class="alert alert-info mt-3 text-center">
                    Il n'y a aucun nouveau rapport validé à consulter pour le moment.
                </div>
            <?php else: ?>
                <!-- Table des résultats -->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="index.php?uc=rapportvisite&action=afficherrapport&rapports=<?php echo $rapport['RAP_NUM']; ?>&matricule=<?php echo $rapport['COL_MATRICULE']; ?>"
                                            class="btn btn-sm btn-info text-white">Consulter</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                ...
                <small class="text-muted"><?php echo count($result); ?> rapport(s) à consulter</small>
            <?php endif; ?>
        </div>
    </div>
</div>