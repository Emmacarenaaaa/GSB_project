...
--
-- Host: 127.0.0.1:3307
-- Generation Time: May 13, 2026 at 12:47 PM
...
CREATE TABLE IF NOT EXISTS `collaborateur` (
  ...
  `COL_NOM` varchar(255) DEFAULT NULL,
  `COL_PRENOM` varchar(255) DEFAULT NULL,
  `COL_ADRESSE` varchar(255) DEFAULT NULL,
  `COL_CP` varchar(255) DEFAULT NULL,
  `COL_VILLE` varchar(255) DEFAULT NULL,
  `COL_DATEEMBAUCHE` varchar(255) DEFAULT NULL,
  `SEC_CODE` varchar(1) DEFAULT NULL,
  `REG_CODE` varchar(2) DEFAULT NULL,
  PRIMARY KEY (`COL_MATRICULE`),
  KEY `visiteur_secteur0_FK` (`SEC_CODE`),
  KEY `visiteur_region1_FK` (`REG_CODE`),
  KEY `collaborateur_habilitation_FK` (`HAB_id`)
...
('a131', 2, 'Villechalane', 'Louis', '8 cours Lafontaine', '29000', 'BREST', '1992-12-11 00:00:00', NULL, 'NO'),
('a17', 1, 'Andre', 'David', '1 r Aimon de Chissée', '38100', 'GRENOBLE', '1991-08-26 00:00:00', NULL, 'RA'),
('a55', 2, 'Bedos', 'Christian', '1 r Bénédictins', '65000', 'TARBES', '1987-07-17 00:00:00', NULL, 'OC'),
('a93', 2, 'Tusseau', 'Louis', '22 r Renou', '86000', 'POITIERS', '1999-01-02 00:00:00', NULL, 'AQ'),
('b13', 1, 'Bentot', 'Pascal', '11 av 6 Juin', '67000', 'STRASBOURG', '1996-03-11 00:00:00', NULL, 'GE'),
('b16', 2, 'Bioret', 'Luc', '1 r Linne', '35000', 'RENNES', '1997-03-21 00:00:00', NULL, 'BG'),
('b19', 2, 'Bunisset', 'Francis', '10 r Nicolas Chorier', '85000', 'LA ROCHE SUR YON', '1999-01-31 00:00:00', NULL, 'PL'),
('b25', 1, 'Bunisset', 'Denise', '1 r Lionne', '49100', 'ANGERS', '1994-07-03 00:00:00', NULL, 'PL'),
('b28', 2, 'Cacheux', 'Bernard', '114 r Authie', '34000', 'MONTPELLIER', '2000-08-02 00:00:00', NULL, 'OC'),
('b34', 2, 'Cadic', 'Eric', '123 r Caponière', '41000', 'BLOIS', '1993-12-06 00:00:00', NULL, 'CE'),
('b4', 1, 'Charoze', 'Catherine', '100 pl Géants', '33000', 'BORDEAUX', '1997-09-25 00:00:00', NULL, 'AQ'),
('b50', 2, 'Clepkens', 'Christophe', '12 r Fédérico Garcia Lorca', '13000', 'MARSEILLE', '1998-01-18 00:00:00', NULL, 'PA'),
('b59', 1, 'Cottin', 'Vincenne', '36 sq Capucins', '5000', 'GAP', '1995-10-21 00:00:00', NULL, 'RA'),
('c14', 1, 'Daburon', 'François', '13 r Champs Elysées', '6000', 'NICE', '1989-02-01 00:00:00', NULL, 'PA'),
('c3', 1, 'De', 'Philippe', '13 r Charles Peguy', '10000', 'TROYES', '1992-05-05 00:00:00', NULL, 'GE'),
('d13', 2, 'Debelle', 'Jeanne', '134 r Stalingrad', '44000', 'NANTES', '1991-12-05 00:00:00', NULL, 'PL'),
('d51', 1, 'Debroise', 'Michel', '2 av 6 Juin', '70000', 'VESOUL', '1997-11-18 00:00:00', NULL, 'FC'),
('e22', 2, 'Desmarquest', 'Nathalie', '14 r Fédérico Garcia Lorca', '54000', 'NANCY', '1989-03-24 00:00:00', NULL, 'GE'),
('e24', 1, 'Desnost', 'Pierre', '16 r Barral de Montferrat', '55000', 'VERDUN', '1993-05-17 00:00:00', NULL, 'GE'),
('e39', 2, 'Dudouit', 'Frederic', '18 quai Xavier Jouvin', '75000', 'PARIS', '1988-04-26 00:00:00', NULL, 'IF'),
('e49', 1, 'Duncombe', 'Claude', '19 av Alsace Lorraine', '9000', 'FOIX', '1996-02-19 00:00:00', NULL, 'OC'),
('e5', 2, 'Enault-Pascreau', 'Celine', '25B r Stalingrad', '40000', 'MONT DE MARSAN', '1990-11-27 00:00:00', NULL, 'AQ'),
...
('g7', 1, 'Guindon', 'Caroline', '40 r Mar Montgomery', '87000', 'LIMOGES', '1996-01-13 00:00:00', NULL, 'AQ'),
...
('k4', 1, 'Lanne', 'Bernard', '4 r Bayeux', '30000', 'NIMES', '1996-11-21 00:00:00', NULL, 'OC'),
('k53', 1, 'Le', 'Noel', '4 av Beauvert', '68000', 'MULHOUSE', '1983-03-23 00:00:00', NULL, 'GE'),
('l14', 1, 'Le', 'Jean', '39 r Raspail', '53000', 'LAVAL', '1995-02-02 00:00:00', NULL, 'PL'),
('l23', 2, 'Leclercq', 'Servane', '11 r Quinconce', '18000', 'BOURGES', '1995-06-05 00:00:00', NULL, 'AQ'),
('l46', 1, 'Lecornu', 'Jean-Bernard', '4 bd Mar Foch', '72000', 'LA FERTE BERNARD', '1997-01-24 00:00:00', NULL, 'PL'),
('l56', 1, 'Lecornu', 'Ludovic', '4 r Abel Servien', '25000', 'BESANCON', '1996-02-27 00:00:00', NULL, 'FC'),
('m35', 2, 'Lejard', 'Agnès', '4 r Anthoard', '82000', 'MONTAUBAN', '1987-10-06 00:00:00', NULL, 'OC'),
('m45', 1, 'Lesaulnier', 'Pascal', '47 r Thiers', '57000', 'METZ', '1990-10-13 00:00:00', NULL, 'GE'),
('n42', 1, 'Letessier', 'Stephane', '5 chem Capuche', '27000', 'EVREUX', '1996-03-06 00:00:00', NULL, 'NO'),
('n58', 1, 'Loirat', 'Didier', 'Les Pêchers cité Bourg la Croix', '45000', 'ORLEANS', '1992-08-30 00:00:00', NULL, 'CE'),
('n59', 2, 'Maffezzoli', 'Thibaud', '5 r Chateaubriand', '2000', 'LAON', '1994-12-19 00:00:00', NULL, 'HF'),
('o26', 1, 'Mancini', 'Anne', '5 r D\'Agier', '48000', 'MENDE', '1995-01-05 00:00:00', NULL, 'OC'),
('p32', 2, 'Marcouiller', 'Gerard', '7 pl St Gilles', '91000', 'ISSY LES MOULINEAUX', '1992-12-24 00:00:00', NULL, 'IF'),
('p40', 1, 'Michel', 'Jean-Claude', '5 r Gabriel Péri', '61000', 'FLERS', '1992-12-14 00:00:00', NULL, 'NO'),
('p41', 1, 'Montecot', 'Françoise', '6 r Paul Valéry', '17000', 'SAINTES', '1998-07-27 00:00:00', NULL, 'AQ'),
('p42', 1, 'Notini', 'Veronique', '5 r Lieut Chabal', '60000', 'BEAUVAIS', '1994-12-12 00:00:00', NULL, 'HF'),
('p49', 2, 'Onfroy', 'Den', '5 r Sidonie Jacolin', '37000', 'TOURS', '1977-10-03 00:00:00', NULL, 'CE'),
('p6', 2, 'Pascreau', 'Charles', '57 bd Mar Foch', '64000', 'PAU', '1997-03-30 00:00:00', NULL, 'AQ'),
('p7', 1, 'Pernot', 'Claude-Noël', '6 r Alexandre 1 de Yougoslavie', '11000', 'NARBONNE', '1990-03-01 00:00:00', NULL, 'OC'),
('p8', 1, 'Perrier', 'Maitre', '6 r Aubert Dubayet', '71000', 'CHALON SUR SAONE', '1991-06-23 00:00:00', NULL, 'FC'),
('q17', 1, 'Petit', 'Jean-Louis', '7 r Ernest Renan', '50000', 'SAINT LO', '1997-09-06 00:00:00', NULL, 'NO'),
('r24', 2, 'Piquery', 'Patrick', '9 r Vaucelles', '14000', 'CAEN', '1984-07-29 00:00:00', NULL, 'NO'),
('r58', 1, 'Quiquandon', 'Joel', '7 r Ernest Renan', '29000', 'QUIMPER', '1990-06-30 00:00:00', NULL, 'BG'),
('s10', 2, 'Retailleau', 'Josselin', '88Bis r Saumuroise', '39000', 'DOLE', '1995-11-14 00:00:00', NULL, 'FC'),
('s21', 2, 'Retailleau', 'Pascal', '32 bd Ayrault', '23000', 'MONTLUCON', '1992-09-25 00:00:00', NULL, 'AQ'),
('t43', 2, 'Souron', 'Maryse', '7B r Gay Lussac', '21000', 'DIJON', '1995-03-09 00:00:00', NULL, 'FC'),
('t47', 2, 'Tiphagne', 'Patrick', '7B r Gay Lussac', '62000', 'ARRAS', '1997-08-29 00:00:00', NULL, 'HF'),
('t55', 2, 'Trehet', 'Alain', '7D chem Barral', '12000', 'RODEZ', '1994-11-29 00:00:00', NULL, 'OC'),
('t60', 1, 'Tusseau', 'Josselin', '63 r Bon Repos', '28000', 'CHARTRES', '1991-03-29 00:00:00', NULL, 'CE'),
('vis01', 1, 'Martin', 'Sophie', '5 rue du Midi', '31000', 'TOULOUSE', '2015-03-10', NULL, 'OC'),
('vis02', 1, 'Dupont', 'Marc', '12 av des Pins', '34000', 'MONTPELLIER', '2018-06-01', NULL, 'OC'),
('vis03', 1, 'Bernard', 'Claire', '3 r Victoire', '33000', 'BORDEAUX', '2020-01-15', NULL, 'AQ');
...
(101, 'marsop', '6c759141febd969896a49c013271968942dae74b7f17516d03c3f34bb033d4bebd59166de124fd141a22066fca287703c80c822b65ee09a75f5c2535fe8840ac', 'vis01'),
(102, 'dupmar', '6c759141febd969896a49c013271968942dae74b7f17516d03c3f34bb033d4bebd59166de124fd141a22066fca287703c80c822b65ee09a75f5c2535fe8840ac', 'vis02'),
(103, 'bercla', '6c759141febd969896a49c013271968942dae74b7f17516d03c3f34bb033d4bebd59166de124fd141a22066fca287703c80c822b65ee09a75f5c2535fe8840ac', 'vis03');
...
CREATE TABLE IF NOT EXISTS `motif` (
  `MO_Code` int(5) NOT NULL,
  `MO_Libelle` varchar(50) NOT NULL,
  PRIMARY KEY (`MO_Code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin;
...
INSERT INTO `offrir` (`qte_off`, `med_depotlegal`, `rap_num`, `col_matricule`) VALUES
(5, 'DOLRIL7', 8, 'a131');
...
CREATE TABLE IF NOT EXISTS `praticien` (
  ...
  `PRA_COEFCONFIANCE` float DEFAULT 0.5,
...
(1, 'Alain', 'Notini', '114 r Authie', '85000', 'LA ROCHE SUR YON', 290.03, 0.5, 'MH'),
(2, 'Albert', 'Gosselin', '13 r Devon', '41000', 'BLOIS', 307.49, 0.5, 'MV'),
(3, 'André', 'Delahaye', '36 av 6 Juin', '25000', 'BESANCON', 185.79, 0.5, 'PS'),
(4, 'André', 'Leroux', '47 av Robert Schuman', '60000', 'BEAUVAIS', 172.04, 0.5, 'PH'),
(5, 'Anne', 'Desmoulins', '31 r St Jean', '30000', 'NIMES', 94.75, 0.5, 'PO'),
(6, 'Anne', 'Mouel', '27 r Auvergne', '80000', 'AMIENS', 45.2, 0.5, 'MH'),
(7, 'Antoine', 'Desgranges-Lentz', '1 r Albert de Mun', '29000', 'MORLAIX', 20.07, 0.5, 'MV'),
(8, 'Arnaud', 'Marcouiller', '31 r St Jean', '68000', 'MULHOUSE', 396.52, 0.5, 'PS'),
(9, 'Benoit', 'Dupuy', '9 r Demolombe', '34000', 'MONTPELLIER', 395.66, 0.5, 'PH'),
(10, 'Bernard', 'Lerat', '31 r St Jean', '59000', 'LILLE', 257.79, 0.5, 'PO'),
(11, 'Bertrand', 'Marçais-Lefebvre', '86Bis r Basse', '67000', 'STRASBOURG', 450.96, 0.5, 'MH'),
(12, 'Bruno', 'Boscher', '94 r Falaise', '10000', 'TROYES', 356.14, 0.5, 'MV'),
(13, 'Catherine', 'Morel', '21 r Chateaubriand', '75000', 'PARIS', 379.57, 0.5, 'PS'),
(14, 'Chantal', 'Guivarch', '4 av Gén Laperrine', '45000', 'ORLEANS', 114.56, 0.5, 'PH'),
(15, 'Christophe', 'Bessin-Grosdoit', '92 r Falaise', '06000', 'NICE', 222.06, 0.5, 'PO'),
(16, 'Claire', 'Rossa', '14 av Thiès', '06000', 'NICE', 529.78, 0.5, 'MH'),
(17, 'Denis', 'Cauchy', '5 av Ste Thérèse', '11000', 'NARBONNE', 458.82, 0.5, 'MV'),
(18, 'Dominique', 'Gaffé', '9 av 1ère Armée Française', '35000', 'RENNES', 213.4, 0.5, 'PS'),
(19, 'Dominique', 'Guenon', '98 bd Mar Lyautey', '44000', 'NANTES', 175.89, 0.5, 'PH'),
(20, 'Dominique', 'Prévot', '29 r Lucien Nelle', '87000', 'LIMOGES', 151.36, 0.5, 'PO'),
(21, 'Eliane', 'Houchard', '9 r Demolombe', '49100', 'ANGERS', 436.96, 0.5, 'MH'),
(22, 'Elisabeth', 'Desmons', '51 r Bernières', '29000', 'QUIMPER', 281.17, 0.5, 'MV'),
(23, 'Elisabeth', 'Flament', '11 r Pasteur', '35000', 'RENNES', 315.6, 0.5, 'PS'),
(24, 'Emmanuel', 'Goussard', '9 r Demolombe', '41000', 'BLOIS', 40.72, 0.5, 'PH'),
(25, 'Eric', 'Desprez', '9 r Vaucelles', '33000', 'BORDEAUX', 406.85, 0.5, 'PO'),
(26, 'Evelyne', 'Coste', '29 r Lucien Nelle', '19000', 'TULLE', 441.87, 0.5, 'MH'),
(27, 'Frédéric', 'Lefebvre', '2 pl Wurzburg', '55000', 'VERDUN', 573.63, 0.5, 'MV'),
(28, 'Frédéric', 'Lemée', '29 av 6 Juin', '56000', 'VANNES', 326.4, 0.5, 'PS'),
(29, 'Frédéric', 'Martin', 'Bât A 90 r Bayeux', '70000', 'VESOUL', 506.06, 0.5, 'PH'),
(30, 'Frédérique', 'Marie', '172 r Caponière', '70000', 'VESOUL', 313.31, 0.5, 'PO'),
(31, 'Geneviève', 'Rosenstech', '27 r Auvergne', '75000', 'PARIS', 366.82, 0.5, 'MH'),
(32, 'Ghislaine', 'Pontavice', '8 r Gaillon', '86000', 'POITIERS', 265.58, 0.5, 'MV'),
(33, 'Guillaume', 'Leveneur-Mosquet', '47 av Robert Schuman', '64000', 'PAU', 184.97, 0.5, 'PS'),
(34, 'Guy', 'Blanchais', '30 r Authie', '08000', 'SEDAN', 502.48, 0.5, 'PH'),
(35, 'Hugues', 'Leveneur', '7 pl St Gilles', '62000', 'ARRAS', 7.39, 0.5, 'PO'),
(36, 'Isabelle', 'Mosquet', '22 r Jules Verne', '76000', 'ROUEN', 77.1, 0.5, 'MH'),
(37, 'Jean-Christophe', 'Giraudon', '1 r Albert de Mun', '38100', 'VIENNE', 92.62, 0.5, 'MV'),
(38, 'Jean-Claude', 'Marie', '26 r Hérouville', '69000', 'LYON', 120.1, 0.5, 'PS'),
(39, 'Jean-François', 'Maury', '5 r Pierre Girard', '71000', 'CHALON SUR SAONE', 13.73, 0.5, 'PH'),
(40, 'Jean-Louis', 'Dennel', '7 pl St Gilles', '28000', 'CHARTRES', 550.69, 0.5, 'PO'),
(41, 'Jean-Pierre', 'Ain', '4 résid Olympia', '02000', 'LAON', 5.59, 0.5, 'MH'),
(42, 'Jean-Pierre', 'Chemery', '51 pl Ancienne Boucherie', '14000', 'CAEN', 396.58, 0.5, 'MV'),
(43, 'Jean-Pierre', 'Comoz', '35 r Auguste Lechesne', '18000', 'BOURGES', 340.35, 0.5, 'PS'),
(44, 'Jean-Pierre', 'Desfaudais', '7 pl St Gilles', '29000', 'BREST', 71.76, 0.5, 'PH'),
(45, 'JérÃ´me', 'Phan', '9 r Clos Caillet', '79000', 'NIORT', 451.61, 0.5, 'PO'),
(46, 'Line', 'Riou', '43 bd Gén Vanier', '77000', 'MARNE LA VALLEE', 193.25, 0.5, 'MH'),
(47, 'Louis', 'Chubilleau', '46 r Eglise', '17000', 'SAINTES', 202.07, 0.5, 'MV'),
(48, 'Lucette', 'Lebrun', '178 r Auge', '54000', 'NANCY', 410.41, 0.5, 'PS'),
(49, 'Marc', 'Goessens', '6 av 6 Juin', '39000', 'DOLE', 548.57, 0.5, 'PH'),
(50, 'Marc', 'Laforge', '5 résid Prairie', '50000', 'SAINT LO', 265.05, 0.5, 'PO'),
(51, 'Marc', 'Millereau', '36 av 6 Juin', '72000', 'LA FERTE BERNARD', 430.42, 0.5, 'MH'),
(52, 'Marie-Christine', 'Dauverne', '69 av Charlemagne', '21000', 'DIJON', 281.05, 0.5, 'MV'),
...
(60, 'Patrice', 'Lecuirot', 'résid St Pères 55 r Pigacière', '54000', 'NANCY', 239.66, 0.5, 'PO'),
(61, 'Patrick', 'Gandon', '47 av Robert Schuman', '37000', 'TOURS', 599.06, 0.5, 'MH'),
(62, 'Patrick', 'Mirouf', '22 r Puits Picard', '74000', 'ANNECY', 458.42, 0.5, 'MV'),
(63, 'Philippe', 'Boireaux', '14 av Thiès', '10000', 'CHALON EN CHAMPAGNE', 454.48, 0.5, 'PS'),
(64, 'Philippe', 'Cendrier', '7 pl St Gilles', '12000', 'RODEZ', 164.16, 0.5, 'PH'),
(65, 'Philippe', 'Duhamel', '114 r Authie', '34000', 'MONTPELLIER', 98.62, 0.5, 'PO'),
(66, 'Philippe', 'Grigy', '15 r Mélingue', '44000', 'CLISSON', 285.1, 0.5, 'MH'),
(67, 'Philippe', 'Linard', '1 r Albert de Mun', '81000', 'ALBI', 486.3, 0.5, 'MV'),
(68, 'Philippe', 'Lozier', '8 r Gaillon', '31000', 'TOULOUSE', 48.4, 0.5, 'PS'),
(69, 'Pierre', 'Dechâtre', '63 av Thiès', '23000', 'MONTLUCON', 253.75, 0.5, 'PH'),
(70, 'Pierre', 'Goessens', '22 r Jean Romain', '40000', 'MONT DE MARSAN', 426.19, 0.5, 'PO'),
(71, 'Pierre', 'Leménager', '39 av 6 Juin', '57000', 'METZ', 118.7, 0.5, 'MH'),
(72, 'Pierre', 'Née', '39 av 6 Juin', '82000', 'MONTAUBAN', 72.54, 0.5, 'MV'),
(73, 'Pierre-Laurent', 'Guyot', '43 bd Gén Vanier', '48000', 'MENDE', 352.31, 0.5, 'PS'),
(74, 'Roger', 'Chauchard', '9 r Vaucelles', '13000', 'MARSEILLE', 552.19, 0.5, 'PH'),
(75, 'Roland', 'Mabire', '11 r Boutiques', '67000', 'STRASBOURG', 422.39, 0.5, 'PO'),
(76, 'Soazig', 'Leroy', '45 r Boutiques', '61000', 'ALENCON', 570.67, 0.5, 'MH'),
(77, 'Stéphane', 'Guyot', '26 r Hérouville', '46000', 'FIGEAC', 28.85, 0.5, 'MV'),
(78, 'Sylvain', 'Delposen', '39 av 6 Juin', '27000', 'DREUX', 292.01, 0.5, 'PS'),
(79, 'Sylvie', 'Rault', '15 bd Richemond', '02000', 'SOISSON', 526.6, 0.5, 'PH'),
(80, 'Sylvie', 'Renouf', '98 bd Mar Lyautey', '88000', 'EPINAL', 425.24, 0.5, 'PO'),
(81, 'Thierry', 'Alliet-Grach', '14 av Thiès', '07000', 'PRIVAS', 451.31, 0.5, 'MH'),
(82, 'Thierry', 'Bayard', '92 r Falaise', '42000', 'SAINT ETIENNE', 271.71, 0.5, 'MV'),
(83, 'Thierry', 'Gauchet', '7 r Desmoueux', '38100', 'GRENOBLE', 406.1, 0.5, 'PS'),
(84, 'Tristan', 'Bobichon', '219 r Caponière', '09000', 'FOIX', 218.36, 0.5, 'PH'),
...
CREATE TABLE IF NOT EXISTS `prescrire` (
  ...
  KEY `prescrire_dosage1` (`dos_code`),
  KEY `prescrire_medicament1` (`med_depotlegal`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin;
...
CREATE TABLE IF NOT EXISTS `rapport_visite` (
  ...
  `RAP_MOTIF_AUTRE` varchar(50) DEFAULT NULL,
  `RAP_AUTRE` varchar(90) DEFAULT NULL,
  `RAP_DATESAISIE` date NOT NULL,
  `ET_CODE` int(11) DEFAULT 1,
  `PRA_NUM` int(11) NOT NULL,
  `MO_Code` int(11) DEFAULT NULL,
  `PRA_NUM_REMPLACANT` int(11) DEFAULT NULL,
  `MED_DEPOTLEGAL_PRESENTER1` varchar(10) DEFAULT NULL,
  `MED_DEPOTLEGAL_PRESENTER2` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`COL_MATRICULE`,`RAP_NUM`),
  KEY `rapport_visite_praticien2_FK` (`PRA_NUM`),
  KEY `rapport_visite_etat_FK` (`ET_CODE`),
  KEY `rapport_visite_motif_FK` (`MO_Code`),
  KEY `rapport_visite_remplaceur_FK` (`PRA_NUM_REMPLACANT`),
  KEY `rapport_visite_med1_FK` (`MED_DEPOTLEGAL_PRESENTER1`),
  KEY `rapport_visite_med2_FK` (`MED_DEPOTLEGAL_PRESENTER2`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin;
...
('a131', 8, '2026-05-06', 'tres bien', NULL, NULL, '2026-05-06', 0, 90, 2, NULL, NULL, NULL),
...
('vis01', 1, '2025-10-15', 'Visite productive, médecin intéressé par AMOPIL7.', NULL, NULL, '2025-10-16', 1, 65, 1, NULL, NULL, NULL),
('vis01', 2, '2025-11-20', 'Médecin absent, rendez-vous reporté.', NULL, NULL, '2025-11-21', 1, 9, 2, NULL, NULL, NULL),
('vis01', 3, '2026-01-10', 'Bilan positif, commande d\'échantillons DOLRIL7.', NULL, NULL, '2026-01-10', 1, 67, 3, NULL, NULL, NULL),
('vis01', 4, '2026-03-05', 'Présentation TRIMYCINE bien accueillie.', NULL, NULL, '2026-03-06', 1, 64, 1, NULL, NULL, NULL),
('vis02', 1, '2025-09-08', 'Premier contact positif avec le Dr Duhamel.', NULL, NULL, '2025-09-09', 1, 65, 2, NULL, NULL, NULL),
('vis02', 2, '2025-12-12', 'Discussion sur les génériques, intéressé.', NULL, NULL, '2025-12-13', 1, 73, 1, NULL, NULL, NULL),
('vis02', 3, '2026-02-18', 'Visite de routine, aucun changement notable.', NULL, NULL, '2026-02-18', 1, 9, 4, NULL, NULL, NULL),
('vis03', 1, '2025-10-22', 'Très bon accueil, médecin prescripteur actif.', NULL, NULL, '2025-10-23', 1, 25, 1, NULL, NULL, NULL),
('vis03', 2, '2026-01-30', 'Présentation URIREGUL, suivi à prévoir.', NULL, NULL, '2026-01-30', 1, 70, 2, NULL, NULL, NULL),
('vis03', 3, '2026-04-14', 'Remise d\'échantillons AMOXAR acceptée.', NULL, NULL, '2026-04-15', 1, 85, 3, NULL, NULL, NULL);
...
ALTER TABLE `prescrire`
  ...
  ADD CONSTRAINT `prescrire_medicament1` FOREIGN KEY (`med_depotlegal`) REFERENCES `medicament` (`MED_DEPOTLEGAL`),
...
ALTER TABLE `rapport_visite`
  ...
  ADD CONSTRAINT `rapport_visite_med1_FK` FOREIGN KEY (`MED_DEPOTLEGAL_PRESENTER1`) REFERENCES `medicament` (`MED_DEPOTLEGAL`),
  ADD CONSTRAINT `rapport_visite_med2_FK` FOREIGN KEY (`MED_DEPOTLEGAL_PRESENTER2`) REFERENCES `medicament` (`MED_DEPOTLEGAL`),
  ADD CONSTRAINT `rapport_visite_motif_FK` FOREIGN KEY (`MO_Code`) REFERENCES `motif` (`MO_Code`),
  ADD CONSTRAINT `rapport_visite_praticien_FK` FOREIGN KEY (`PRA_NUM`) REFERENCES `praticien` (`PRA_NUM`),
  ADD CONSTRAINT `rapport_visite_remplacant_FK` FOREIGN KEY (`PRA_NUM_REMPLACANT`) REFERENCES `praticien` (`PRA_NUM`),
